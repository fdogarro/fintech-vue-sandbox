<template>
  <v-container fluid style="padding:0">
     <v-layout row wrap>
       <v-flex xs2>
         <v-menu offset-y>
        <v-btn slot="activator" color="grey darken-4" dark>Select a View</v-btn>
        <v-list>
   ...
   <v-layout row wrap>
    ...
    <!-- </v-layout> -->
         <!-- <v-checkbox v-for="item in mainChartData" v-model="selected" :label="item.chartData" :value="item.chartData"></v-checkbox> -->
         ...
         <ag-grid-vue style="width: 15%; height: 560px;"
                      :gridOptions="fundsYOptions"
                      :rowClicked="onRowYColumnClick"
                      :toolPanelSuppressSideButtons="true"
        ...
        <ag-grid-vue style="width: 12%; height: 560px;"
                     :gridOptions="chartOptions"
