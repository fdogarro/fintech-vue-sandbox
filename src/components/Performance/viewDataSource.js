...
export function ViewportDatasource(mockServer, gridOptions) {
    this.mockServer = mockServer;
    this.gridOptions = gridOptions;
    console.log("This Grid Options", this.gridOptions)
...
ViewportDatasource.prototype.init = function(params) {
    this.params = params;
    console.log("Viewport Datasource", params);
};
...
ViewportDatasource.prototype.eventListener = function(event) {
  // console.log('Datasource e', event)
...
ViewportDatasource.prototype.onRowData = function(event) {
    ...
    console.log("Row Data Server", rowDataFromServer);
    this.params.setRowData(rowDataFromServer);
};

ViewportDatasource.prototype.onSortChanged = function(event) {
    console.log("On Sort Changed", event);
};

ViewportDatasource.prototype.onFilterChanged = function(event) {
    console.log("On Filter Changed", event);
};
