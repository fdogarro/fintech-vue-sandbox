...
MockServer.prototype.getData = function(req, callback){
  console.log("Second Req + CB");
}
...
MockServer.prototype.sendResultsToClient = function(connectionId, firstRow, lastRow) {
    ...
    // console.log("First Row", firstRow, lastRow, rowDataMap, rowsInClient)


    // console.log("Results To Client", connectionId, firstRow, lastRow, rowsInClient, rowDataMap)
